          ...
          proc do
            ...
            if params['id'].present?
              begin
                ...
                if params['ajax'].present?
                  render text: I18n.t('admin.hancock_cache_restore_snapshot.error', err: e.to_s), status: 422
                else
              ...
              if params['ajax'].present?
                render text: I18n.t('admin.hancock_cache_restore_snapshot.no_id'), status: 422
              else
